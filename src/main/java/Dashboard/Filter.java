...
public class Filter {
    ...
    public Metrics filterMetrics(Multimap<String, Record> filteredMap) {
    ...
    private Multimap<String, ImpressionRecord> getImpressionsByDateMap(String context, Multimap<String, ImpressionRecord> impressionRecords) {
        return Multimaps.filterValues(impressionRecords, impressionRecord -> impressionRecord != null && impressionRecord.getContext().equalsIgnoreCase(context));
    }
